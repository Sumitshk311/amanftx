...
const AboutMe = () => {
  ...
  return (
    <section className="relative min-h-screen bg-[#020205] flex items-center pt-20 pb-20 overflow-hidden">
          ...
          <div className="flex-1 space-y-6 text-center md:text-left">
            <div className="space-y-2">
              <span className="flex items-center justify-center md:justify-start gap-2 text-purple-500 text-[10px] font-black uppercase tracking-[0.4em]">
                <Sparkles size={12} /> Who is Aman?
              </span>
              <h2 className="text-5xl md:text-7xl font-black text-white italic tracking-tighter uppercase leading-none">
                Visual <br />
                <span className="text-purple-600">Storyteller.</span>
              </h2>
            </div>

            <p className="text-gray-400 text-base md:text-lg leading-relaxed max-w-lg mx-auto md:mx-0">
              I’m a creative editor specializing in high-retention <span className="text-white">Anime Aesthetics</span> and cinematic brand stories. I help creators turn raw footage into visual masterpieces that command attention.
            </p>
